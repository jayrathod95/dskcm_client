package com.deskcomm.ui.imported.jtoast.notification;

import com.deskcomm.ui.imported.jtoast.animations.*;
...
public final class JToast {
    ...
    private void initAnimations() {
        ...
        animationProvider =
                new AnimationProvider(new JFade(stage), new JPop(stage));
